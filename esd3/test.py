...
# # Test different parameter configurations at checkpoints
# print("\nTesting different parameter configurations at checkpoints 0, 5, and 10:")
# checkpoint_prices = [
#     [300, 300, 300],  # Checkpoint 0 (initial prices)
#     [250, 275, 225],  # Checkpoint 5 (example prices)
#     [200, 225, 175]   # Checkpoint 10 (example prices)
# ]

# for inertia in inertia_factors:
#     for sensitivity_mean in price_sensitivity_means:
#         for sensitivity_std in price_sensitivity_stds:
#             for smoothing in smoothing_factors:
#                 print(f"\nParameters: inertia={inertia}, sensitivity_mean={sensitivity_mean}, "
#                       f"sensitivity_std={sensitivity_std}, smoothing={smoothing}")
                
#                 for checkpoint, prices in enumerate(checkpoint_prices):
#                     market_shares = calculate_market_share(
#                         prices=prices,
#                         inertia_factor=inertia,
#                         price_sensitivity_mean=sensitivity_mean,
#                         price_sensitivity_std=sensitivity_std,
#                         smoothing_factor=smoothing,
#                         total_customers=CUSTOMERS
#                     )
#                     print(f"Checkpoint {checkpoint*5}: Prices={prices}, Market Shares={market_shares}")
