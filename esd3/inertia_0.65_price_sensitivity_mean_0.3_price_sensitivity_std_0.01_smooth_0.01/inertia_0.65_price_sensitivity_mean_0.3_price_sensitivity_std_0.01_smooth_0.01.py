...
def calculate_market_share(prices, inertia_factor=0.65, price_sensitivity_mean=0.3, price_sensitivity_std=0.01, smoothing_factor=0.01, total_customers=1000):
