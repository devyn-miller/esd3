...
def calculate_market_share(prices, inertia_factor=0.75, price_sensitivity_mean=0.2, price_sensitivity_std=0.01, smoothing_factor=0.05, total_customers=1000):
